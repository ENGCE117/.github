...
* **การบ้าน 10%** : เพื่อทบทวนเนื้อหาก่อนเรียนด้วยตนเอง รายละเอียดดังต่อไปนี้
    - แก้โจทย์ปัญหาทุกข้อ[ในลิงค์ต่อไปนี้](https://www.thailandfxwarrior.com/coding/course/basic)
    - ระยะเวลาในการตรวจ : ภายใน 45 วัน หลังจากเริ่มเรียนวิชานี้ครั้งแรก **เท่านั้น!!**
* **ปฏิบัติ (Lab) 20%** : ปฏิบัติตามชุดปฏิบัติให้ครบทุกแล็ป [ในลิงค์ต่อไปนี้](https://www.thailandfxwarrior.com/coding/course/engce117)
* **สอบปฏิบัติ 20%**
